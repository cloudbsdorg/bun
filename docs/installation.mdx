...
Bun ships as a single, dependency-free executable. You can install it via script, package manager, or Docker across macOS, Linux, Windows, and FreeBSD.
...
<Tabs>
  <Tab title="macOS, Linux & FreeBSD">
    ...
    <Note>
      ...
      **FreeBSD users** — FreeBSD 13.0 or higher is required.
      </Note>
