...
# Exclude trusted packages from the age gate. Bare names bypass the
# gate for every version; "name@version" whitelists a single vetted
# version without opening the door to future releases.
